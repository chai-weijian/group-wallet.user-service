...
public class ListSerializer<Inner> implements Serializer<List<Inner>> {
    ...
    private CustomSerdes.ListSerde.SerializationStrategy serStrategy;
    ...
    public ListSerializer(Serializer<Inner> inner) {
        ...
        this.inner = inner;
        this.serStrategy = FIXED_LENGTH_SERIALIZERS.contains(inner.getClass()) ? CustomSerdes.ListSerde.SerializationStrategy.CONSTANT_SIZE : CustomSerdes.ListSerde.SerializationStrategy.VARIABLE_SIZE;
    }
    ...
    public void configure(Map<String, ?> configs, boolean isKey) {
        ...
        final String innerSerdePropertyName = isKey ? DEFAULT_LIST_KEY_SERDE_INNER_CLASS : DEFAULT_LIST_VALUE_SERDE_INNER_CLASS;
        ...
        try {
            ...
            serStrategy = FIXED_LENGTH_SERIALIZERS.contains(inner.getClass()) ? CustomSerdes.ListSerde.SerializationStrategy.CONSTANT_SIZE : CustomSerdes.ListSerde.SerializationStrategy.VARIABLE_SIZE;
    ...
    public byte[] serialize(String topic, List<Inner> data) {
        ...
        try (final ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ...
            for (Inner entry : data) {
                if (entry == null) {
                    if (serStrategy == CustomSerdes.ListSerde.SerializationStrategy.VARIABLE_SIZE) {
